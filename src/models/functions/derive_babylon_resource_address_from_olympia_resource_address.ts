...
export class DeriveBabylonResourceAddressFromOlympiaResourceAddressInput {
...
export class DeriveBabylonResourceAddressFromOlympiaResourceAddressOutput {
  @Expose({ name: "babylon_resource_address" })
  @Type(() => String)
  babylonResourceAddress: string;

  constructor(babylonResourceAddress: string) {
