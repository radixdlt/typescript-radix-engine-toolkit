...
export class ManifestBuilder {
   ...
   * @returns A `ManifestBuilder` which the caller can continue chaining calls to.
   */
  createIdentityAdvanced(config: ManifestAstValue.Value): ManifestBuilder {
    let instruction = new CreateIdentityAdvanced(config);
    this.instructions.push(instruction);
    return this;
  }
   ...
   * @returns A `ManifestBuilder` which the caller can continue chaining calls to.
   */
  createAccountAdvanced(config: ManifestAstValue.Value): ManifestBuilder {
    let instruction = new CreateAccountAdvanced(config);
    this.instructions.push(instruction);
    return this;
  }
